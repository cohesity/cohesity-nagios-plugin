...
class Cohesityclusterhealth(nagiosplugin.Resource):
    ...
    def get_cluster_status(self):
        ...
        try:
            ...
            alerts_list = alerts.get_alerts(alert_category_list=AlertCategoryListEnum.KCLUSTERHEALTH, max_alerts=100,
    ...
    def probe(self):
        ...
        metric = nagiosplugin.Metric('Unhealthy cluster alerts', bad_c, min=0, context='bad_c')
        return metric
...
def main():
    ...
    args = parse_args()
    check = nagiosplugin.Check( Cohesityclusterhealth(args.ip, args.user, args.password) )
